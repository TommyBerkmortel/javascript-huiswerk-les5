...
async function fetchCountries() {
    try {
        ...
        if (error.response.status === 500) errorMessage.textContent = "Er ging iets mis in de server";
        else if (error.response.status === 404) errorMessage.textContent = "Het verzoek is mislukt";
    }
}
fetchCountries();
